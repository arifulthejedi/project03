...
//api routes
/dishes 
#all dishe is show in this route support only get method

/delete-dish
#delete dish support only post method with user credentials(name,pass)

/add-dish
#add dish support only post method with user credentials(name,pass)

/update-dish
#add dish support only post method with user credentials(name,pass)

/login
#user auth only post method with user credentials(name,pass)
...
/messages
#see all contact message support only post method with user credentials(name,pass)

/delete-message
#delete a contact message support only post method with user credentials(name,pass)
...
/bookings
#all filed from bookings table

/delete-booking
#delete a booking | post resquest with user credentials
